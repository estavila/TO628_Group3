...
Data includes targeted and general measures. When the general column is 1 it means the data was general (for teh whole country), when the general column is 0 it means the data was targetted to a specific geographical locaiton. We are only interested in looking at data generally applied to the whole country.
```{r ,}
...
for (country in top) {
  ...
  dates = sort(df_country_reset$Date, incomparables = FALSE)
