...
df_flat <- rbind(df_flat, data.frame(Date=as.Date("1993-03-01"),
                                     CountryName="country",
                                     CountryCode ="cc",
                                     S1_School.closing = as.integer(1),
                                     S2_Workplace.closing = as.integer(2),
                                     S3_Cancel.public.events = as.integer(3),
                                     S4_Close.public.transport = as.integer(4),
                                     S5_Public.information.campaigns = as.integer(5),
                                     S6_Restrictions.on.internal.movement = as.integer(6),
                                     ...
                                     ConfirmedCases = as.integer(15),
                                     ConfirmedDeaths = as.integer(16)))
...
```{r ,}
## FINDING ZERO DAY OF EACH COUNTRY
c = 'a'
print(top30)
