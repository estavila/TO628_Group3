...
for (country in top) {
  ...
  for (d in seq_along(dates)){
    ...
    if (d ==1){
      ...
      g_rate = as.integer(df_date$ConfirmedCases[df_date$Date == dates[d]]-df_date$ConfirmedCases[df_date$Date == dates[1]])
    }
...
India
```{r}
df_model_India_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "India"))
  
summary(df_model_India_1)

df_model_India_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "India"))
...
Iran
```{r}
df_model_Iran_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Iran"))
  
summary(df_model_Iran_1)

df_model_Iran_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Iran"))
