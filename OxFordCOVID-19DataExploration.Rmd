...
```
>>>>>>> 92edc5e559b23d4a10fed09ce1c1dc774c90deb7
...
df_model_Germany_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + StringencyIndexForDisplay
                        + S6_Restrictions.on.internal.movement + S4_Close.public.transport, data = subset(df_flat, CountryName == "Germany"))
  
summary(df_model_Germany_1)

df_model_Germany_2 <- lm(ConfirmedCases ~  S1_School.closing + S2_Workplace.closing + S4_Close.public.transport
                         + S6_Restrictions.on.internal.movement, data = subset(df_flat, CountryName == "Germany"))
...
US
```{r}
df_model_US_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S10_Emergency.investment.in.health.care
                    + S13_Contact.tracing, data = subset(df_flat, CountryName == "United States"))
  
summary(df_model_US_1)

df_model_US_2 <- lm(ConfirmedCases ~ S2_Workplace.closing + S8_Fiscal.measures, data = subset(df_flat, CountryName == "United States"))
...
```{r}
df_model_UK_1 <- lm(ConfirmedDeaths ~ S12_Testing.framework + StringencyIndexForDisplay + S11_Investment.in.Vaccines, data = subset(df_flat, CountryName == "United Kingdom"))
  
summary(df_model_UK_1)

df_model_UK_2 <- lm(ConfirmedCases ~ S8_Fiscal.measures + S11_Investment.in.Vaccines + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "United Kingdom"))
...
South Korea
```{r}
df_model_SouthKorea_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S3_Cancel.public.events + StringencyIndexForDisplay , data = subset(df_flat, CountryName == "South Korea"))
...
df_model_SouthKorea_2 <- lm(ConfirmedCases ~ S6_Restrictions.on.internal.movement  + S8_Fiscal.measures + S9_Monetary.measures , data = subset(df_flat, CountryName == "South Korea"))
...
Iran
```{r}
df_model_Iran_1 <- lm(ConfirmedDeaths ~ S2_Workplace.closing + S3_Cancel.public.events + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Iran"))
summary(df_model_Iran_1)

df_model_Iran_2 <- lm(ConfirmedCases ~ S3_Cancel.public.events + S4_Close.public.transport + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Iran"))
...
Sweden
```{r}
df_model_Sweden_1 <- lm(ConfirmedDeaths ~ S3_Cancel.public.events + S6_Restrictions.on.internal.movement, data = subset(df_flat, CountryName == "Sweden"))
  
summary(df_model_Sweden_1)



df_model_Sweden_2 <- lm(ConfirmedCases ~ S6_Restrictions.on.internal.movement + S7_International.travel.controls, data = subset(df_flat, CountryName == "Sweden"))
...
China
```{r}
df_model_China_1 <- lm(ConfirmedDeaths ~ S1_School.closing, data = subset(df_flat, CountryName == "China"))
...
df_model_China_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S8_Fiscal.measures, data = subset(df_flat, CountryName == "China"))
...
Italy
```{r}
df_model_Italy_1 <- lm(ConfirmedDeaths ~ S4_Close.public.transport+ S6_Restrictions.on.internal.movement, data = subset(df_flat, CountryName == "Italy"))

summary(df_model_Italy_1)
             

df_model_Italy_2 <- lm(ConfirmedCases ~ S2_Workplace.closing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Italy"))
...
=======
#### Growth Rate
>>>>>>> 1b8c32498ed68ef4c9a297e55ff38b65a8e1d78d
```{r}
str(df_flat)
# Run Linear Regression model. 
