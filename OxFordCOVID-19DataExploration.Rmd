...
g_rate_mod2<-lm(GrowthRate ~ S1_School.closing+S2_Workplace.closing+S3_Cancel.public.events+S4_Close.public.transport+S5_Public.information.campaigns+S6_Restrictions.on.internal.movement+S7_International.travel.controls+S8_Fiscal.measures+S9_Monetary.measures+S10_Emergency.investment.in.health.care+S11_Investment.in.Vaccines+S12_Testing.framework+S13_Contact.tracing+S6_Restrictions.on.internal.movement*S4_Close.public.transport+S7_International.travel.controls*S4_Close.public.transport+S1_School.closing*S2_Workplace.closing+S3_Cancel.public.events*S4_Close.public.transport,  data=df_flat)
summary(g_rate_mod2)

g_rate_mod3<-lm(GrowthRate ~ S1_School.closing+S2_Workplace.closing+S3_Cancel.public.events+S4_Close.public.transport+S5_Public.information.campaigns+S6_Restrictions.on.internal.movement+S7_International.travel.controls+S8_Fiscal.measures+S9_Monetary.measures+S10_Emergency.investment.in.health.care+S11_Investment.in.Vaccines+S12_Testing.framework+S13_Contact.tracing+S6_Restrictions.on.internal.movement*S7_International.travel.controls*S4_Close.public.transport+S1_School.closing*S2_Workplace.closing+S3_Cancel.public.events*S4_Close.public.transport,  data=df_flat)
summary(g_rate_mod3)
#residualPlots(g_rate_mod3)
...
g_ratef_mod2<-lm(GrowthRateFut ~ S1_School.closing+S2_Workplace.closing+S3_Cancel.public.events+S4_Close.public.transport+S5_Public.information.campaigns+S6_Restrictions.on.internal.movement+S7_International.travel.controls+S8_Fiscal.measures+S9_Monetary.measures+S10_Emergency.investment.in.health.care+S11_Investment.in.Vaccines+S12_Testing.framework+S13_Contact.tracing+S6_Restrictions.on.internal.movement*S4_Close.public.transport+S7_International.travel.controls*S4_Close.public.transport+S1_School.closing*S2_Workplace.closing+S3_Cancel.public.events*S4_Close.public.transport,  data=df_flat)
summary(g_rate_mod2)

g_ratef_mod3<-lm(GrowthRateFut ~ S1_School.closing+S2_Workplace.closing+S3_Cancel.public.events+S4_Close.public.transport+S5_Public.information.campaigns+S6_Restrictions.on.internal.movement+S7_International.travel.controls+S8_Fiscal.measures+S9_Monetary.measures+S10_Emergency.investment.in.health.care+S11_Investment.in.Vaccines+S12_Testing.framework+S13_Contact.tracing+S6_Restrictions.on.internal.movement*S7_International.travel.controls*S4_Close.public.transport+S1_School.closing*S2_Workplace.closing+S3_Cancel.public.events*S4_Close.public.transport,  data=df_flat)
summary(g_ratef_mod3)
...
for(country in top){
  df_model_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       ...
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == country))
  
  summary(df_model_1)
  
  df_model_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == country ))
...
```{r}
#Austria
df_model_Austria_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Austria"))
  
summary(df_model_Austria_1)

df_model_Austria_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Austria"))
  
summary(df_model_Austria_2)
...
df_flat$CountryCode <- NULL
df_model_Belgium_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Belgium"))
  
summary(df_model_Belgium_1)

df_model_Belgium_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Belgium"))
  
summary(df_model_Belgium_2)
...
df_model_Brazil_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Brazil"))
  
summary(df_model_Brazil_1)

df_model_Brazil_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Brazil"))
  
summary(df_model_Brazil_2)
```


Canada
```{r}
df_model_Canada_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Canada"))
  
summary(df_model_Brazil_1)

df_model_Canada_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Canada"))
  
summary(df_model_Canada_2)
```

Chile

```{r}
df_model_Chile_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Chile"))
  
summary(df_model_Chile_1)

df_model_Chile_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Chile"))
  
summary(df_model_Chile_2)
```
...
```{r}
df_model_China_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "China"))
  
summary(df_model_China_1)

df_model_China_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "China"))
...
```{r}
df_model_Ecuador_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Ecuador"))
  
summary(df_model_Ecuador_1)

df_model_Ecuador_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Ecuador"))
  
summary(df_model_Ecuador_2)
```


France
```{r}
df_model_France_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "France"))
  
summary(df_model_France_1)

df_model_France_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "France"))
  
summary(df_model_France_2)
```


Germany
```{r}
df_model_Germany_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Germany"))
  
summary(df_model_Germany_1)

df_model_Germany_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Germany"))
...
India
```{r}
df_model_India_1 <- lm(ConfirmedDeaths ~ S1_School.closing  + S2_Workplace.closing
                      + S12_Testing.framework
                       , data = subset(df_flat, CountryName == "India"))
  
summary(df_model_India_1)


df_model_India_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing
                       + S12_Testing.framework
                       , data = subset(df_flat, CountryName == "India"))
...
Iran
```{r}
df_model_Iran_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S3_Cancel.public.events
                      + S8_Fiscal.measures
                      , data = subset(df_flat, CountryName == "Iran"))
  
summary(df_model_Iran_1)

df_model_Iran_2 <- lm(ConfirmedCases ~ S8_Fiscal.measures + S1_School.closing 
                     , data = subset(df_flat, CountryName == "Iran"))
...
Ireland
```{r}
df_model_Ireland_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Ireland"))
  
summary(df_model_Ireland_1)

df_model_Ireland_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Ireland"))
  
summary(df_model_Ireland_2)
```


Israel
```{r}
df_model_Israel_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Israel"))
  
summary(df_model_Israel_1)

df_model_Israel_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Israel"))
  
summary(df_model_Israel_2)
```

Italy
```{r}
df_model_Italy_1 <- lm(ConfirmedDeaths ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Italy"))
  
summary(df_model_Italy_1)

df_model_Italy_2 <- lm(ConfirmedCases ~ S1_School.closing + S2_Workplace.closing + S3_Cancel.public.events
                       + S4_Close.public.transport + S5_Public.information.campaigns + S6_Restrictions.on.internal.movement
                       + S7_International.travel.controls + S8_Fiscal.measures + S9_Monetary.measures
                       + S10_Emergency.investment.in.health.care + S11_Investment.in.Vaccines + S12_Testing.framework 
                       + S13_Contact.tracing + StringencyIndexForDisplay, data = subset(df_flat, CountryName == "Italy"))
